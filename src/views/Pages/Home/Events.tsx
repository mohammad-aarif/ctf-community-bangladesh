...
const Events = () => {
    return (
        <div id='events' className='lg:px-32 md:px-24 sm:px-2 py-5'>
            <h1 className="text-2xl font-bold text-center">Upcoming Events</h1>
        <div className='lg:px-16 md:px-16 sm:px-2 grid lg:grid-cols-7 md:grid-cols-3 sm:grid-cols-1  py-5'>
            <div className='md:col-span-1 lg:col-span-3'>
                <img  className="events-image" src="https://miro.medium.com/max/1400/1*ydhn1QPAKsrbt6UWfn3YnA.jpeg" alt="" />
            </div>
            <div style={{padding: '0 20px'}} className='lg:col-span-4 md:col-span-2 lg:pl-16 md:pl-12'>
